...
This repository serves as a comprehensive collection of 22 foundational and intermediate projects built using **HTML, CSS, JavaScript, Canvas, and browser tooling**. It showcases my skills in front-end development, DOM manipulation, API integration, interactive web design, algorithmic UI, and animation. Each project is designed to demonstrate specific concepts and techniques, ranging from simple UI components to more complex applications.
...
A Canvas animation that renders a stylized night scene with falling stars, gravity, friction, collision response, shattering particles, background stars, and layered mountain silhouettes.

*   **Key Features:** Full-screen canvas, randomized star spawning, impact shatter particles, gravity/friction physics, resize-aware rendering.
*   **Technologies:** HTML5 Canvas, JavaScript, Webpack, Babel, BrowserSync.
*   **[View Project](https://github.com/aryan2064/web-wonders/tree/main/22%20Star-Shower)**
...
| 22 | Star Shower | Animated night-sky scene with falling stars and shattering particles | Canvas animation loop, gravity/friction physics, particle effects, Webpack/Babel bundling | [View Project](https://github.com/aryan2064/web-wonders/tree/main/22%20Star-Shower) |
...
*   **Canvas API:** Pixel rendering, animation loops, interactive visualizations, and particle effects.
*   **Build Tooling:** Webpack/Babel setup for bundled Canvas projects such as Star Shower.
